...
// @access Public
export const getPremise = (_req: Request, res: Response) => {
...
// @access Private
export const createPremise = (_req: Request, res: Response) => {
...
// @access Private
export const updatePremise = (req: Request, res: Response) => {
  res.status(200).json({ success: true, msg: `Update Premise ${req.params.id}` });
};

// Desc: Delete Premise
// @route DELETE /api/availabilities/:id
// @access Private
export const deletePremise = (req: Request, res: Response) => {
