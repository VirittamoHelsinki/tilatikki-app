...
const FloorPlan3 = ({floorData}) => {
  ...
  const roomProps = {
    101: { x: 197, y: 0, width: 45, height: 45 },
    102: { x: 246, y: 0, width: 150, height: 45 },
    103: { x: 400, y: 0, width: 84, height: 78 },
    104: { x: 438, y: 82, width: 46, height: 46 },
    105: { x: 438, y: 132, width: 46, height: 46 },
    106: { x: 400, y: 182, width: 84, height: 46 },
    107: { x: 86, y: 0, width: 107, height: 81 },
